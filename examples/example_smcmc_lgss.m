...
par_apf = struct( ...
    'sample', @sample_fapf, ...
    'calculate_weights', @calculate_weights_generic ...
);
...
par_mcmc = struct( ...
    ...
    ...  %'sample', @sample_smcmc_prior, ...
    'calculate_weights', [] ...         % **IMPORTANT**: This is required for SMCMC samplers, otherwise the results will be wrong!
);
